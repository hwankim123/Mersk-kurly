...
public class ItemRepository {
  //category, 검색어 따로 String 상수로 두기 -> 동적 쿼리로 업그레이드
  ...
  private final RowMapper<Item> ROW_MAPPER = (resultSet, rowNum) -> {
    ...
    return Item.getInstance(id, memberId, name, category, description, price, stock, buyCnt, createdAt, updatedAt);
  };
  ...
  public List<Item> findByKeyword(String keyword){
    return jdbcTemplate.queryForList(
        FIND_BY_KEYWORD,
        Collections.singletonMap(KEYWORD, keyword),
        Item.class);
  }
